...
/** The internal wrapper for freeHEP SVG graphics */
final class _FreeHEPSVGGraphic extends SVGGraphics2D {
   ...
   *          the logger
   */
  _FreeHEPSVGGraphic(final OutputStream _os, final Dimension size,
      final Logger logger) {
    super(_os, size);
  ...
  public final void writeError(final Exception exception) {
    ErrorUtils.logError(this.m_logger, //
        "Error while creating SVG graphic.", //$NON-NLS-1$
