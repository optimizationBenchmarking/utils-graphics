...
public abstract class SimplifyingGraphicProxy<GT extends Graphics2D>
  ...
  private static final int NEEDS_FLUSH_LINES = (AbstractGraphic.BEFORE_CLEAR
      | AbstractGraphic.BEFORE_IMAGE | AbstractGraphic.BEFORE_3D_RECT
      | AbstractGraphic.BEFORE_CREATE_GRAPHIC
      | AbstractGraphic.BEFORE_COPY_AREA
      | AbstractGraphic.BEFORE_CHANGE_COMPOSITE
      | AbstractGraphic.BEFORE_CHANGE_PAINT
      | AbstractGraphic.BEFORE_CHANGE_COLOR
      | AbstractGraphic.BEFORE_CHANGE_BACKGROUND_COLOR
      | AbstractGraphic.BEFORE_CHANGE_STROKE
      | AbstractGraphic.BEFORE_CHANGE_RENDERING_HINTS
      | AbstractGraphic.BEFORE_CHANGE_TRANSFORMATION
      | AbstractGraphic.BEFORE_CHANGE_CLIP
      | AbstractGraphic.BEFORE_CHANGE_PAINT_MODE);
  ...
  /** {@inheritDoc} */
  @Override
  protected final void doDrawLine(final int x1, final int y1, final int x2,
      final int y2) {
  ...
  private final void __flushRectangle(final __LineSegment a,
      final __LineSegment b, final __LineSegment c,
      final __LineSegment d) {
  ...
  static final class __LineSegment extends Line2D.Double {
    ...
    public final boolean equals(final Object o) {
      ...
      if (o instanceof __LineSegment) {
        ...
        return ((x1a == x1b) && (y1a == y1b) && (x2a == x2b)
            && (y2a == y2b));
      }
      return false;
    }
  ...
  /** the internal proxy */
  private final class __InternalSimplifyingGraphicProxy
      extends SimplifyingGraphicProxy<Graphics2D> {
