 ...
 * <a href="http://en.wikipedia.org/wiki/Portable_Document_Format">PDF</a>
...
public final class FreeHEPPDFGraphicDriver extends AbstractGraphicDriver {
  ...
  private static final Map<Object, Object> __initialize()
    ...
    props.setProperty(org.freehep.graphicsio.pdf.PDFGraphics2D.EMBED_FONTS,
        true);
    props.setProperty(
    ...
    props.setProperty(org.freehep.graphicsio.pdf.PDFGraphics2D.COMPRESS,
        true);
    props.setProperty(org.freehep.graphicsio.pdf.PDFGraphics2D.FIT_TO_PAGE,
        false);
    props.setProperty(org.freehep.graphicsio.pdf.PDFGraphics2D.VERSION, //
        org.freehep.graphicsio.pdf.PDFGraphics2D.VERSION6);
    props.setProperty(org.freehep.graphicsio.pdf.PDFGraphics2D.ORIENTATION,
