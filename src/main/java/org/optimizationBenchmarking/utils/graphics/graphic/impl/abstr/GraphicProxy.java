 ...
 */
public abstract class GraphicProxy<GT extends Graphics2D>
  ...
  /** {@inheritDoc} */
  @Override
  protected void doDrawRoundRect(final int x, final int y, final int width,
  ...
  /** {@inheritDoc} */
  @Override
  protected void doFillRoundRect(final int x, final int y, final int width,
      final int height, final int arcWidth, final int arcHeight) {
  ...
  protected void doDrawRoundRect(final double x, final double y,
    ...
    if (this.m_out instanceof Graphic) {
      ((Graphic) (this.m_out)).drawRoundRect(x, y, width, height, arcWidth,
          arcHeight);
    } else {
  ...
  protected void doFillRoundRect(final double x, final double y,
      ...
      final double arcHeight) {
    if (this.m_out instanceof Graphic) {
      ((Graphic) (this.m_out)).fillRoundRect(x, y, width, height, arcWidth,
          arcHeight);
    } else {
  ...
  /** the internal proxy */
  private final class __InternalGraphicProxy
      extends GraphicProxy<Graphics2D> {
