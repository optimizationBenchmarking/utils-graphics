 ...
 * graphic
 */
final class _FreeHEPPDFGraphicWrapper
    extends _FreeHEPAbstractVectorGraphicsProxy<_FreeHEPPDFGraphic> {
   ...
   *          the height
   */
  _FreeHEPPDFGraphicWrapper(final _FreeHEPPDFGraphic graphic,
