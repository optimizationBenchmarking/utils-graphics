...
/**
 * A driver which creates Java's raster
 * <a href="http://en.wikipedia.org/wiki/Graphics_Interchange_Format">GIF
 * </a> graphics.
 */
public final class ImageIOGIFGraphicDriver
    extends _ImageIORasterGraphicDriver {
  ...
  /** {@inheritDoc} */
  @Override
  final _ImageIORasterGraphic _create(final Path path, final Logger logger,
