...
public class FontProperties extends HashObject {
  ...
  private static final int FONT_FLAG_FAMILY = (FontProperties.FONT_FLAG_MONOSPACE
      ...
      | FontProperties.FONT_FLAG_DIALOG
      | FontProperties.FONT_FLAG_DIALOG_INPUT);
  ...
  private static final int FONT_FLAG_ALL = (FontProperties.FONT_FLAG_BOLD
      ...
      | FontProperties.FONT_FLAG_MONOSPACE | FontProperties.FONT_FLAG_SERIF
      | FontProperties.FONT_FLAG_SANS_SERIF
      | FontProperties.FONT_FLAG_DIALOG
      | FontProperties.FONT_FLAG_DIALOG_INPUT);
  ...
  public static final FontProperties getFontProperties(final String name) {
    ...
    beginner = TextUtils.toComparisonCase(beginner);
  ...
  public static final FontProperties getFontProperties(final Font font,
    ...
    if (fp != null) {
      ...
      if (((fam1 == 0) || (fam1 == FontProperties.FONT_FLAG_DIALOG)
          || (fam1 == FontProperties.FONT_FLAG_DIALOG_INPUT))
          && (((fam2 != 0) && (fam2 != FontProperties.FONT_FLAG_DIALOG)
              && (fam2 != FontProperties.FONT_FLAG_DIALOG_INPUT)))) {
  ...
  private static final class __FontFlags extends FontProperties
      implements Comparable<__FontFlags> {
    ...
    private __FontFlags(final String data, final int idx) {
      ...
      this.m_name = TextUtils.toComparisonCase(TextUtils.prepare(//
