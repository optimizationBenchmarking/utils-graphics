...
public class FontPaletteXMLHandler extends DelegatingHandler {
  ...
  protected final void doStartElement(final String uri,
    ...
    this.m_inFace = false;
    if ((uri == null)
        || (FontPaletteXML.NAMESPACE.equalsIgnoreCase(uri))) {
      ...
      if (FontPaletteXML.ELEMENT_FONT_FACE.equalsIgnoreCase(localName)) {
        ...
        this.m_type = FontPaletteXML
            ._parseFontType(DelegatingHandler.getAttribute(attributes,
                FontPaletteXML.NAMESPACE, FontPaletteXML.ATTRIBUTE_TYPE));
        this.m_faceChoice.clear();
        return;
      }

      if (FontPaletteXML.ELEMENT_FONT_PALETTE
      ...
      this.m_builder
          .setFontFamily(FontPaletteXML._parseFontFamily(DelegatingHandler
    ...
    if ((uri == null)
      ...
      if (FontPaletteXML.ELEMENT_FONT.equalsIgnoreCase(localName)
          ...
          || FontPaletteXML.ELEMENT_EMPHASIZED_FONT
              .equalsIgnoreCase(localName)
          || FontPaletteXML.ELEMENT_CODE_FONT
              .equalsIgnoreCase(localName)) {
