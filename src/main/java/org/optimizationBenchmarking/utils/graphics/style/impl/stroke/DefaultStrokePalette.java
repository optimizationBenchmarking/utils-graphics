...
public final class DefaultStrokePalette extends StrokePalette {
  ...
  private static final class __DefaultStrokePaletteBuilder
      extends StrokePaletteBuilder {
    /** the default palette builder */
  ...
  private static final class __DefaultStrokePaletteLoader {
    ...
    static {
      ...
      try (
          final __DefaultStrokePaletteBuilder cspb = new __DefaultStrokePaletteBuilder()) {
        StrokePaletteXMLInput.getInstance().use().setLogger(logger)
            .setDestination(cspb)
            .addResource(DefaultStrokePalette.class,
                "default.strokePalette") //$NON-NLS-1$
            .create().call();
        pal = cspb.getResult();
