 ...
 */
public final class FontStyleBuilder
    extends StylePaletteElementBuilder<IFontStyle> {
  ...
  /**
   * Set the size of this font style in {@code pt}
   *
   * @param size
   *          the size of this font style in {@code pt}
   */
  ...
  /**
   * Get the size of this font in {@code pt}
   *
   * @return the size of this font in {@code pt}
   */
  ...
  public synchronized final boolean addFaceChoice(final String name,
    ...
    return this.m_faceChoices
        .add(new _FaceChoice(this.normalize(name), resource, type));
  }
   ...
   */
  private static final boolean __matches(final Font font,
      final String name) {
  ...
  protected final FontStyle compile() {
          ...
          if (FontStyleBuilder.__isAllowed(font.getFamily())) {
            ...
            if (faceChoice.m_resource != null) {
              ...
              if (is != null) {
                try {
                  font = Font
                      .createFont(faceChoice.m_type.getJavaFontType(), is);
                  if (font != null) {
                    try {
                    ...
                    if (FontStyleBuilder.__matches(font,
                        faceChoice.m_name)) {
                      chosenName = faceChoice.m_name;
    ...
    if (this.m_id == null) {
      ...
      this.m_id = NormalCharTransformer.getInstance()
          .transform(idb.toString());
    }
  ...
  /** {@inheritDoc} */
  @Override
  public synchronized final void fromStrings(
    ...
    t = strings.next();
    this.setBold(
        (t != null) && LooseBooleanParser.INSTANCE.parseBoolean(t));
