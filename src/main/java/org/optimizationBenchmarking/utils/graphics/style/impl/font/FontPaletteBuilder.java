 ...
 */
public class FontPaletteBuilder
    extends StylePaletteBuilder<IFontStyle, FontPalette> {
  ...
  /** {@inheritDoc} */
  @Override
  protected final FontPalette createPalette(
      final ArrayList<IFontStyle> data) {
  ...
  protected final void processElementBuilder(
      final StylePaletteElementBuilder<IFontStyle> child) {
    final FontStyleBuilder ssb;

    ssb = ((FontStyleBuilder) child);
    switch (ssb.m_choice) {
      case 0: {
        this.setDefaultFont((FontStyle) (ssb.getResult()));
        break;
      }
      case 1: {
        this.setEmphFont((FontStyle) (ssb.getResult()));
        break;
      }
      case 2: {
        this.setCodeFont((FontStyle) (ssb.getResult()));
        break;
      }
      case 3: {
