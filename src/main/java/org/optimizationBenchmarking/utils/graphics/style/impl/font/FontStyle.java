 ...
 * {@code eps} figures in a LaTeX document apply the exactly same fonts as
 * the main font.
 * </p>
 */
public final class FontStyle extends FontProperties implements IFontStyle {
            ...
            | ((family == EFontFamily.MONOSPACED)
                ...
                : ((family == EFontFamily.SANS_SERIF)
                    ...
                    : ((family == EFontFamily.SERIF)
                        ...
                        : ((family == EFontFamily.DIALOG)
                            ? FontProperties.FONT_FLAG_DIALOG
                            : ((family == EFontFamily.DIALOG_INPUT)
  ...
  public final boolean appendDescription(final ETextCase textCase,
    ...
    if (this.m_palette != null) {
      def = ((FontStyle) (this.m_palette.getDefaultFont()));
    ...
    x = this.isUnderlined();
    if (x && ((def == null) || (x != def.isUnderlined())
        || (!omitDefaults))) {
      if (have) {
        if (haveSpecial) {
